...
I read [this article] about Bitcoin. In essence, it says that what's really
interesting about Bitcoin is not the currency part, but the way that people
work together. In a way, Bitcoin is a bit like asking "could we use a model
like Airbnb or Uber to run a currency, without a company at the centre?"
Hundreds, thousands, maybe tens of thousands of people work on, around, or
with Bitcoin. But there's no meetings, no votes, no corporate hierarchy.
