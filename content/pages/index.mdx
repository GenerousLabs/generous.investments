...
Crazy? Maybe. I'll try to explain...
...
if we succeed in doing this, we can create entirely new ways of trading that
are based on more than just price.

## How?

I had this idea at Burning Man in 2018. The question I spent 2019
contemplating is how do we build it? How to combine the approach
...
You can read about the model in detail
[here](https://purpose-economy.org/en/whats-steward-ownership/). Simple
summary, there's a fixed maximum amount that investors and founders can be
paid by the company, and after that the company owns itself, and serves its
mission. From that point onwards, all profits are reinvested or donated to
charity.
...
Analytica / Facebook
scandal](https://en.wikipedia.org/wiki/Facebook–Cambridge_Analytica_data_scandal)
possible? Because we all trusted Facebook to handle our data well. Turns out
that was a bad idea.
...
force them to pay. This is where generosity comes in.

My bet is that if we give people awesome software that helps them in a
